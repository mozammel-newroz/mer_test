...
export default class Refund extends Component {
  ...
  handleConfirm(e) {
    ...
    if (this.checkBtn.context._errors.length === 0) {
      MoneyService.refundMoneySummary(
        this.state.receiver_mobile_number,
        this.state.invoice_id,
        this.state.amount
      ).then(
                                  ...
                                  {!this.state.successful && (
                                    <div>
                                      ...
                                      <div className="form-group">
                                        ...
                                        >
                                          <FormattedMessage
                                            id="refund_page_customer_account_no"
                                            defaultMessage="Customer Account Number"
                                          />
                                          :
                                        </h6>
                                      ...
                                      <div className="form-group">
                                        ...
                                        <div className="input-group">
                                          ...
                                          <input
                                            className="form-control MerchantInput zipcode-number"
                                            style={{
                                              borderRadius: "0 16px 16px 0",
                                              borderLeft: "none",
                                              borderRight:
                                ...
                                <div className="col-md-9 col-lg-8 col-xl-6 mx-auto">
                                  ...
                                  >
                                    ...
                                    <p className="text-3 mb-4">
                                      ...
                                      />{" "}
                                      <a className="btn-link" href="/refund">
                                        <FormattedMessage
                                          id="Refund_Money"
                                          defaultMessage="Refund Money"
                                        />
